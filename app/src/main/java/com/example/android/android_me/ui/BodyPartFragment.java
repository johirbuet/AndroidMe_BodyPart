...
public class BodyPartFragment extends Fragment {
    ...
    public static final String BODY_PART_INDEX = "body_part_index";
    // Tag for logging
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(BODY_PART_LIST);
            mListIndex = savedInstanceState.getInt(BODY_PART_INDEX);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(BODY_PART_INDEX,mListIndex);
    }
}
